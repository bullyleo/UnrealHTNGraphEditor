...
UHTNGraphNode* UHTNGraphNode_Composite::GetChildNode(int32 Index) const
{
	...
	//	(Children[Index].ChildComposite ? (UHTNGraphNode*)Children[Index].ChildComposite : (UHTNGraphNode*)Children[Index].ChildTask) : nullptr;
}

//void UHTNGraphNode_Composite::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
//{
